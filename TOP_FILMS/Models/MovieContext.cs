        ...
        public MovieContext(DbContextOptions<MovieContext> options) : base(options) 
        {
            ...
            if (Database.EnsureCreated())
            {
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 1999,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1898899/443e111e-f714-4954-83d0-3e0acca2a561/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 1994,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/4303601/64bc47ac-ad53-461f-ac0f-46e6b9876681/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 1994,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1600647/edea4a0e-06da-4661-93b1-7c0e645ff86f/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 1994,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1946459/eae33fc1-bcb5-450e-89bf-9ba077b24cdf/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 2008,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1600647/1439ad3b-fd22-4fc1-a5cf-2b4fb901a505/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Драма",
                    ReleaseYear = 1997,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1946459/be46b4a0-d5f4-4ba8-9bf8-dd248b0c33d4/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Криминал",
                    ReleaseYear = 1994,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/6201401/97ed7256-db80-4532-ab6b-6688d2eab4b2/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Комедия",
                    ReleaseYear = 1995,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1704946/0ff7142f-4f4f-49af-90e8-20c00d2d4ab7/1920x",
                ...
                Movies?.Add(new Movie
                {
                    ...
                    Genre = "Фантастика",
                    ReleaseYear = 2002,
                    PosterUrl = "https://avatars.mds.yandex.net/get-kinopoisk-image/1777765/ecc77c5c-17cb-4258-b9c9-f58e3a541bf6/1920x",
